...
public class AuctionSearchController {
	...
	public ListResult<Auction> gettingSearchResults(@RequestHeader("X-AUTH-TOKEN") String xAuthToken,@RequestParam @ApiParam(value = "검색 키워드", required = true) String keyword) {
