...
public class LogServiceController {
	...
	public SingleResult<String> getStoreReviewLogURL(@RequestParam @ApiParam(value = "가게 id", required = true)String storeId) {
		String iframeString ="<iframe src=\"http://49.50.160.149:5601/app/dashboards#/view/b629dff0-2b6d-11ec-8087-239c32c86513?embed=true&_g=(filters:!(('$state':(store:globalState),meta:(alias:!n,disabled:!f,index:9c6e5cc0-2a88-11ec-8087-239c32c86513,key:someField.actionType.keyword,negate:!f,params:(query:review),type:phrase),query:(match_phrase:(someField.actionType.keyword:review))),('$state':(store:globalState),meta:(alias:!n,disabled:!f,index:9c6e5cc0-2a88-11ec-8087-239c32c86513,key:someField.storeId,negate:!f,params:(query:'"+storeId+"'),type:phrase),query:(match_phrase:(someField.storeId:'"+storeId+"')))),refreshInterval:(pause:!t,value:0),time:(from:now-7d,to:now))&_a=(description:'',filters:!(),fullScreenMode:!f,options:(hidePanelTitles:!f,useMargins:!t),query:(language:kuery,query:''),timeRestore:!f,title:'store:review',viewMode:view)&hide-filter-bar=true\" height=\"600\" width=\"400\"></iframe>";
		String slashRemovedString =iframeString.replaceAll("/$", "");
		return responseService.getSingleResult(slashRemovedString);
	}
}
